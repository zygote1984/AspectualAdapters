...
public class TestDriver {
	...
	public void testInterpreter() {
		...
		String templateFile = "src/zygote/binding/example/shapes/binding/shapes.aspectbind";
		...
		generator.setOutputPath(URI.createURI("src/zygote/binding/example/shapes/binding"), false);
