...
public interface DeclarationPackage extends EPackage
{
   ...
   * @ordered
   */
  int ADAPTER_DECLARATION_FEATURE_COUNT = DECLARATION_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int ADAPTER_FEATURE_COUNT = org.emftext.language.java.commons.CommonsPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
