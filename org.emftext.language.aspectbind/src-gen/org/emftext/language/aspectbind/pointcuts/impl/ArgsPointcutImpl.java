...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Args Pointcut</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emftext.language.aspectbind.pointcuts.impl.ArgsPointcutImpl#getTypePattern <em>Type Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ArgsPointcutImpl extends PrimitivePointcutImpl implements ArgsPointcut
{
  /**
  ...
  {
    return PointcutsPackage.Literals.ARGS_POINTCUT;
  }
    ...
    if (typePattern != null && typePattern.eIsProxy())
    {
      ...
      if (typePattern != oldTypePattern)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PointcutsPackage.ARGS_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
      }
    }
    return typePattern;
  }
  ...
  public void setTypePattern(TypePattern newTypePattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PointcutsPackage.ARGS_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PointcutsPackage.ARGS_POINTCUT__TYPE_PATTERN:
