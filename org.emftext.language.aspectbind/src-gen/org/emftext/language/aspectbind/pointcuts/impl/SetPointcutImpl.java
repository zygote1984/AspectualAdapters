...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Pointcut</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emftext.language.aspectbind.pointcuts.impl.SetPointcutImpl#getSignature <em>Signature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class SetPointcutImpl extends PrimitivePointcutImpl implements SetPointcut
{
  /**
  ...
  {
    return PointcutsPackage.Literals.SET_POINTCUT;
  }
    ...
    if (signature != null && signature.eIsProxy())
    {
      ...
      if (signature != oldSignature)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PointcutsPackage.SET_POINTCUT__SIGNATURE, oldSignature, signature));
      }
    }
    return signature;
  }
  ...
  public void setSignature(AbstractMethodPattern newSignature)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PointcutsPackage.SET_POINTCUT__SIGNATURE, oldSignature, signature));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PointcutsPackage.SET_POINTCUT__SIGNATURE:
