 ...
 * <ul>
 *   <li>{@link org.emftext.language.aspectbind.pointcuts.impl.StaticInitPointcutImpl#getTypePattern <em>Type Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StaticInitPointcutImpl extends PrimitivePointcutImpl implements StaticInitPointcut
{
    ...
    if (typePattern != null && typePattern.eIsProxy())
    {
      ...
      if (typePattern != oldTypePattern)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PointcutsPackage.STATIC_INIT_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
      }
    }
    return typePattern;
  }
  ...
  public void setTypePattern(TypePattern newTypePattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PointcutsPackage.STATIC_INIT_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PointcutsPackage.STATIC_INIT_POINTCUT__TYPE_PATTERN:
