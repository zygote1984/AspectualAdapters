...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Target Pointcut</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.emftext.language.aspectbind.pointcuts.impl.TargetPointcutImpl#getTypePattern <em>Type Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class TargetPointcutImpl extends PrimitivePointcutImpl implements TargetPointcut
{
  /**
  ...
  {
    return PointcutsPackage.Literals.TARGET_POINTCUT;
  }
    ...
    if (typePattern != null && typePattern.eIsProxy())
    {
      ...
      if (typePattern != oldTypePattern)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PointcutsPackage.TARGET_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
      }
    }
    return typePattern;
  }
  ...
  public void setTypePattern(TypePattern newTypePattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PointcutsPackage.TARGET_POINTCUT__TYPE_PATTERN, oldTypePattern, typePattern));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PointcutsPackage.TARGET_POINTCUT__TYPE_PATTERN:
