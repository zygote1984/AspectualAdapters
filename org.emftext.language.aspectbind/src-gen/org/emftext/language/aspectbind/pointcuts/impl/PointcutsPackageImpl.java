...
public class PointcutsPackageImpl extends EPackageImpl implements PointcutsPackage {
   ...
   */
    ...
    pointcutEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
    ...
    initEReference(getIfPointcut_Exp(), theExpressionsPackage.getConditionalExpression(), null, "exp", null, 0, 1, IfPointcut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPointcut_Exp(), theExpressionsPackage.getConditionalExpression(), null, "exp", null, 0, 1, Pointcut.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
