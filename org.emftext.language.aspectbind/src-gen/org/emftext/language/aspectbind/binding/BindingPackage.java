...
public interface BindingPackage extends EPackage {
   ...
   */
	...
	/**
   * The meta object id for the '{@link org.emftext.language.aspectbind.binding.impl.InstanceImpl <em>Instance</em>}' class.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see org.emftext.language.aspectbind.binding.impl.InstanceImpl
   * @see org.emftext.language.aspectbind.binding.impl.BindingPackageImpl#getInstance()
   * @generated
   */
	int INSTANCE = 1;
   ...
   * @ordered
   */
	int INSTANCE__COMMENTS = PatternsPackage.TYPE_PATTERN__COMMENTS;
   ...
   * @ordered
   */
	int INSTANCE__NAMESPACES = PatternsPackage.TYPE_PATTERN__NAMESPACES;
   ...
   * @ordered
   */
	int INSTANCE_FEATURE_COUNT = PatternsPackage.TYPE_PATTERN_FEATURE_COUNT + 0;
   ...
   */
	...
	/**
   * Returns the meta object for class '{@link org.emftext.language.aspectbind.binding.Instance <em>Instance</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   */
     ...
     */
		...
		/**
     * The meta object literal for the '{@link org.emftext.language.aspectbind.binding.impl.InstanceImpl <em>Instance</em>}' class.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @see org.emftext.language.aspectbind.binding.impl.InstanceImpl
     * @see org.emftext.language.aspectbind.binding.impl.BindingPackageImpl#getInstance()
