 ...
 */
public class AspectbindBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public AspectbindBracketSet(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair>();
	 ...
	 */
	public org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair remove(String opening, String closing) {
		for (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
