...
/**
 * A text editor for 'aspectbind' models.
 */
public class AspectbindEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.language.aspectbind.resource.aspectbind.IAspectbindResourceProvider, org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindBracketHandlerProvider, org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindAnnotationModelProvider {
	
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindCodeFoldingManager codeFoldingManager;
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener>();
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindColorManager colorManager = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindColorManager();
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOutlinePage outlinePage;
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPropertySheetPage propertySheetPage;
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindBracketHandler bracketHandler;
	...
	public AspectbindEditor() {
		super();
		setSourceViewerConfiguration(new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), AspectbindEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource currentResource = getResource();
				...
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.aspectbind.resource.aspectbind.EditorContext");
		setRulerContextMenuId("org.emftext.language.aspectbind.resource.aspectbind.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindNature.activate(inputFile.getProject());
		...
		org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource loadedResource = (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource) {
					setResource((org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the AspectbindEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource textResource = (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource) element.eResource();
			org.emftext.language.aspectbind.resource.aspectbind.IAspectbindLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextToken token = lexer.getNextToken();
			...
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!AspectbindEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.language.aspectbind.resource.aspectbind.ui.IAspectbindBracketHandler bracketHandler) {
