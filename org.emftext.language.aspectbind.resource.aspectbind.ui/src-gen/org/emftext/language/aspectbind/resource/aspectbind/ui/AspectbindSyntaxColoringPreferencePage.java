 ...
 */
public class AspectbindSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public AspectbindSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.aspectbind.resource.aspectbind.IAspectbindMetaInformation syntaxPlugin = new org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPixelConverter pixelConverter = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor) {
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor emfTextEditor = (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor) editor;
