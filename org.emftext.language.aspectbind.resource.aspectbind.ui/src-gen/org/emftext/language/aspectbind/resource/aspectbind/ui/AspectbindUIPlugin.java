 ...
 */
public class AspectbindUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.aspectbind.resource.aspectbind.ui";
	public static final String EDITOR_ID = "org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor";
	...
	private static AspectbindUIPlugin plugin;
	
	public AspectbindUIPlugin() {
		super();
	}
	...
	public static AspectbindUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspectbindUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspectbindUIPlugin.PLUGIN_ID, message);
		}
		final AspectbindUIPlugin pluginInstance = AspectbindUIPlugin.getDefault();
