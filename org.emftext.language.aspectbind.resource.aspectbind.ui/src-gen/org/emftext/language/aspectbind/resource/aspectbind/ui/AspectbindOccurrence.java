 ...
 */
public class AspectbindOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.aspectbind.resource.aspectbind.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.aspectbind.resource.aspectbind.ui.occurences.declaration";
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindTokenScanner tokenScanner;
	...
	private org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource textResource;
	 ...
	 */
	public AspectbindOccurrence(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOccurrence.DECLARATION_ANNOTATION_ID);
	}
