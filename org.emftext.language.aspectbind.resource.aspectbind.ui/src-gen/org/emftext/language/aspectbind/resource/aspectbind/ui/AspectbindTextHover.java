 ...
 */
public class AspectbindTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.emftext.language.aspectbind.resource.aspectbind.IAspectbindHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput infoInput = (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHyperlink hyperlink = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl iControl = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput) {
							org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput input = (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl iControl = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AspectbindTextHover(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindTextHover.getStyleSheet());
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.aspectbind.resource.aspectbind.util.AspectbindStreamUtil.getContent(styleSheetURL.openStream());
