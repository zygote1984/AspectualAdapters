 ...
 */
public class AspectbindHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AspectbindHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
