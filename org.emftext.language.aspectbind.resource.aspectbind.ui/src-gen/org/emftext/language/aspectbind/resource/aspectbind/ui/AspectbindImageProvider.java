 ...
 */
public class AspectbindImageProvider {
	
	public final static AspectbindImageProvider INSTANCE = new AspectbindImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
