 ...
 */
public class AspectbindNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public AspectbindNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.aspectbind.resource.aspectbind.ui");
							...
							String natureID = org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindNature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation info = new org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindMetaInformation();
