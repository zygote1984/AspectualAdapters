 ...
 * a specified depth.
 */
public class AspectbindOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public AspectbindOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindPlugin.logError("Exception while refreshing outline view", e);
		}
	}
