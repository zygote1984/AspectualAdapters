 ...
 */
public class AspectbindNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AspectbindNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new aspectbind file");
