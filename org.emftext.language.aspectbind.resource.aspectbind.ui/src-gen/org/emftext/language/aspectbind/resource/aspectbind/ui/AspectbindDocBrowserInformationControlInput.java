 ...
 * olInput</code>.
 */
public class AspectbindDocBrowserInformationControlInput {
	
	private final AspectbindDocBrowserInformationControlInput fPrevious;
	private AspectbindDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AspectbindDocBrowserInformationControlInput(AspectbindDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AspectbindDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AspectbindDocBrowserInformationControlInput getNext() {
		return fNext;
	}
