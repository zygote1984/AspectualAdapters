 ...
 * @since 3.2
 */
public class AspectbindBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AspectbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AspectbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AspectbindBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput) input;
		...
		org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindDocBrowserInformationControlInput getInput() {
		return fInput;
	}
