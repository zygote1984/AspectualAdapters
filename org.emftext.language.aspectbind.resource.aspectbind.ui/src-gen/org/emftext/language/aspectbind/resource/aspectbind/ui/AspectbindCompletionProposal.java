 ...
 */
public class AspectbindCompletionProposal implements java.lang.Comparable<AspectbindCompletionProposal> {
	...
	public AspectbindCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public AspectbindCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public AspectbindCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof AspectbindCompletionProposal) {
			AspectbindCompletionProposal other = (AspectbindCompletionProposal) object;
	...
	public int compareTo(AspectbindCompletionProposal object) {
		if (object instanceof AspectbindCompletionProposal) {
			AspectbindCompletionProposal other = (AspectbindCompletionProposal) object;
