...
public class AspectbindAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindAnnotationModel(resource);
	}
