 ...
 */
public class AspectbindCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor) {
				org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor = (org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor) workbenchPart;
	...
	protected org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor;
	 ...
	 */
	public AspectbindCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource textResource = (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
