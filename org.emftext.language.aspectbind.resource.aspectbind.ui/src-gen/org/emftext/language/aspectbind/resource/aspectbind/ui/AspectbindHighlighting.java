 ...
 */
public class AspectbindHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionHelper positionHelper = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionHelper();
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindTokenScanner scanner;
	...
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOccurrence occurrence;
	private org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.language.aspectbind.resource.aspectbind.IAspectbindBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public AspectbindHighlighting(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindColorManager colorManager, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindTokenScanner(textResource, colorManager);
		occurrence = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
