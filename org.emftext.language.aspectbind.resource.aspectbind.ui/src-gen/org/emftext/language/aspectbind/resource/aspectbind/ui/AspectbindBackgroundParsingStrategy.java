 ...
 */
public class AspectbindBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource resource, final org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource resource, final org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource resource, final org.emftext.language.aspectbind.resource.aspectbind.ui.AspectbindEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
