...
public class Token {
     ...
     * field is null). The next fields of special tokens refer to other special tokens that immediately follow it (without an
     * intervening regular token). If there is no such token, this field is null.
     */
    public Token specialToken;
    
    /**
     * An optional attribute value of the Token. Tokens which are not used as syntactic sugar will often contain meaningful
     * values that will be used later on by the compiler or interpreter. This attribute value is often different from the
     * image. Any subclass of Token that actually wants to return a non-null value can override this method as appropriate.
     */
     ...
     * of Token called IDToken that you want to create if ofKind is ID, simply add something like : case MyParserConstants.ID
     * : return new IDToken(ofKind, image); to the following switch statement. Then you can cast matchedToken variable to the
    ...
    public static Token newToken(final int ofKind, final String image) {
        ...
        case AJPointcutParserConstants.RUNSIGNEDSHIFT:
        case AJPointcutParserConstants.RSIGNEDSHIFT:
        case AJPointcutParserConstants.GT:
            return new GTToken();
        }
    }
    ...
    public static class GTToken extends Token {
        ...
        int realKind = AJPointcutParserConstants.GT;
    }
...
/* JavaCC - OriginalChecksum=c6b5481b709b564ae1c783b6123009bd (do not edit this line) */
