 ...
 */
public interface IAspectbindTextParser extends org.emftext.language.aspectbind.resource.aspectbind.IAspectbindConfigurable {
	 ...
	 */
	public org.emftext.language.aspectbind.resource.aspectbind.IAspectbindParseResult parse();
	 ...
	 * will not be needed.
	 */
	public java.util.List<org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindExpectedTerminal> parseToExpectedElements(org.eclipse.emf.ecore.EClass type, org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextResource dummyResource, int cursorOffset);
