 ...
 */
public class AspectbindEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindPlugin.logError("Exception while matching proxy URI.", e);
