 ...
 */
public class AspectbindPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.aspectbind.resource.aspectbind";
	/**
	...
	private static AspectbindPlugin plugin;
	
	public AspectbindPlugin() {
		super();
	}
	...
	public static AspectbindPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspectbindPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AspectbindPlugin.PLUGIN_ID, message);
		}
		final AspectbindPlugin pluginInstance = AspectbindPlugin.getDefault();
