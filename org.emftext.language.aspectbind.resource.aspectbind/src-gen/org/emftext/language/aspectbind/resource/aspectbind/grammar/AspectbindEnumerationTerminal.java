 ...
 */
public class AspectbindEnumerationTerminal extends org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public AspectbindEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindCardinality cardinality, int mandatoryOccurrencesAfter) {
