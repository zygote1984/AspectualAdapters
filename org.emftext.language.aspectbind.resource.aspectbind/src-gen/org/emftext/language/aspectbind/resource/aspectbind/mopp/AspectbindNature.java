...
public class AspectbindNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.aspectbind.resource.aspectbind.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
