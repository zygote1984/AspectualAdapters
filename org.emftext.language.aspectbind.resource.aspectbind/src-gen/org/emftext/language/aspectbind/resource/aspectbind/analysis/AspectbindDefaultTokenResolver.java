 ...
 */
public class AspectbindDefaultTokenResolver implements org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTokenResolver {
	 ...
	 */
	public AspectbindDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AspectbindDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindGrammarInformationProvider.INSTANCE.getKeywords()) {
