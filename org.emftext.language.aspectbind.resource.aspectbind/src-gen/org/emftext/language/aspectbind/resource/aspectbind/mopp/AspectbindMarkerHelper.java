 ...
 * contains
 * <code>org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextDiagnos
 * tic</code>s it uses the more precise information of this extended diagnostic
 * type.
 */
public class AspectbindMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object>> commands = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object>> commandsToProcess = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextDiagnostic diagnostic) {
		final org.emftext.language.aspectbind.resource.aspectbind.IAspectbindProblem problem = diagnostic.getProblem();
		org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.emftext.language.aspectbind.resource.aspectbind.IAspectbindCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemSeverity.ERROR) {
					...
					org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextDiagnostic textDiagnostic = (org.emftext.language.aspectbind.resource.aspectbind.IAspectbindTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.language.aspectbind.resource.aspectbind.IAspectbindQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.language.aspectbind.resource.aspectbind.util.AspectbindStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType nextType : org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(org.emftext.language.aspectbind.resource.aspectbind.AspectbindEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
