...
/**
 * A AspectbindLayoutInformationAdapter is used to store layout information that
 ...
 * AspectbindLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class AspectbindLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindLayoutInformation>();
	...
	public java.util.List<org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.aspectbind.resource.aspectbind.mopp.AspectbindLayoutInformation layoutInformation) {
