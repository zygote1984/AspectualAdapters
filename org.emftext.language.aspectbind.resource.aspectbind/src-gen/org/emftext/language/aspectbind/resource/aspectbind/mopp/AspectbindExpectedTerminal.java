 ...
 */
public class AspectbindExpectedTerminal {
	
	private int followSetID;
	private org.emftext.language.aspectbind.resource.aspectbind.IAspectbindExpectedElement terminal;
	...
	public AspectbindExpectedTerminal(org.emftext.language.aspectbind.resource.aspectbind.IAspectbindExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public org.emftext.language.aspectbind.resource.aspectbind.IAspectbindExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((AspectbindExpectedTerminal) o).terminal);
	}
