...
/**
 * A AspectbindLayoutInformation is used to store layout information that is found
 ...
 * AspectbindLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AspectbindLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class AspectbindLayoutInformation {
	
	private final org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindSyntaxElement syntaxElement;
	...
	public AspectbindLayoutInformation(org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.emftext.language.aspectbind.resource.aspectbind.grammar.AspectbindSyntaxElement getSyntaxElement() {
